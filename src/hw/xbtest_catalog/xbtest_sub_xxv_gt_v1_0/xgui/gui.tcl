...
proc update_PARAM_VALUE.ENABLE_RSFEC { PARAM_VALUE.ENABLE_RSFEC } {
    # Procedure called to update ENABLE_RSFEC when any of the dependent parameters in the arguments change
}
proc validate_PARAM_VALUE.ENABLE_RSFEC { PARAM_VALUE.ENABLE_RSFEC } {
    # Procedure called to validate ENABLE_RSFEC
    return true
}
proc update_MODELPARAM_VALUE.ENABLE_RSFEC { MODELPARAM_VALUE.ENABLE_RSFEC PARAM_VALUE.ENABLE_RSFEC } {
     # Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
     set_property value [get_property value ${PARAM_VALUE.ENABLE_RSFEC}] ${MODELPARAM_VALUE.ENABLE_RSFEC}
}