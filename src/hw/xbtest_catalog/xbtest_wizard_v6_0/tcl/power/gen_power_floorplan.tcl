                    ...
                    foreach {x COL_X} $ACTUAL_GEOM_LIST_SITE_SLR_Y_X {
                        ...
                        if {[llength $COL_X] > 0} {
                            ...
                            foreach y $COL_X {
                                ...
                                if     {$site_key == {DSP}}   { set path_site [format "%s/genblk_dsp48\[%d\].u_dsp48e2_top/DSP48E2_inst"      $path_base $idx_site] } \
                                elseif {$site_key == {BRAM}}  { set path_site [format "%s/genblk_ramb36e2\[%d\].u_ramb36e2_top/RAMB36E2_inst" $path_base $idx_site] } \
                                elseif {$site_key == {URAM}}  { set path_site [format "%s/genblk_uram288\[%d\].u_uram288_top/URAM288_inst"    $path_base $idx_site] }
