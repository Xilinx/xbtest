...
module gt_prbs_25_reg_array #(
    ...
    logic [4:0]  gt_txdiffctrl   [3:0]  = '{default:'0};
    logic [6:0]  gt_txmaincursor [3:0]  = '{default: 7'h50};  // from XXV example design trans_debug
    ...
    assign cfg_lane[0] = {1'b0, gt_loopback[0], 3'b0, gt_rxlpmen[0], 1'b0, gt_txpolarity[0], gt_txpostcursor[0], gt_txmaincursor[0], gt_txprecursor[0], gt_txdiffctrl[0]} ;
    assign cfg_lane[1] = {1'b0, gt_loopback[1], 3'b0, gt_rxlpmen[1], 1'b0, gt_txpolarity[1], gt_txpostcursor[1], gt_txmaincursor[1], gt_txprecursor[1], gt_txdiffctrl[1]} ;
    assign cfg_lane[2] = {1'b0, gt_loopback[2], 3'b0, gt_rxlpmen[2], 1'b0, gt_txpolarity[2], gt_txpostcursor[2], gt_txmaincursor[2], gt_txprecursor[2], gt_txdiffctrl[2]} ;
    assign cfg_lane[3] = {1'b0, gt_loopback[3], 3'b0, gt_rxlpmen[3], 1'b0, gt_txpolarity[3], gt_txpostcursor[3], gt_txmaincursor[3], gt_txprecursor[3], gt_txdiffctrl[3]} ;

    wire [17:0]  status_cdc_in;
    wire [17:0]  status_cdc_out;
    ...
    assign status_cdc_in = {gt_reset_rx_done, gt_reset_tx_done, gt_power_good, Tx_Seed_Zero, Rx_Seed_Zero, Rx_PRBS_Error};

    assign Rx_PRBS_Error_cdc = status_cdc_out[3:0];
    assign Rx_Seed_Zero_cdc = status_cdc_out[7:4];
    assign Tx_Seed_Zero_cdc = status_cdc_out[11:8];
    assign gt_power_good_cdc = status_cdc_out[15:12];
    assign gt_reset_tx_done_cdc = status_cdc_out[16];
    assign gt_reset_rx_done_cdc = status_cdc_out[17];
