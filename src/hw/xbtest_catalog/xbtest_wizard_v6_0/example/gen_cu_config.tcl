        ...
        if {$aie_geometry_slr != {}} {
            ...
            if {$aie_utilization_slr == {}} {
                ...
                if {$use_aie} {
                    ...
                    gen_aie_constraints_json config cu_cfg $aie_geometry_slr $aie_utilization_slr
                }
            }
        }
...
proc gen_aie_constraints_json { config_ref cfg_ref aie_geometry_slr aie_utilization_slr } {
    ...
    dict set cu_cfg aie_constraints_json   aie_constraints_SLR${slr_idx}.json
