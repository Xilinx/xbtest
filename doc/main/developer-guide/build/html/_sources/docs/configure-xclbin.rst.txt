...
.. table:: xbtest clocks
    ...
    +--------------+----------------+-------------------+-----------------------------------------------------------------------+
    | CU RTL Name  | Vitis Name     | Default frequency | Description                                                           |
    +==============+================+===================+=======================================================================+
    | ``ap_clk``   | ``DATA_CLK``   | 300 MHz           | CU <-> memory connection (DDR/HBM/PLRAM/HOST)                         |
    +--------------+----------------+-------------------+-----------------------------------------------------------------------+
    | ``ap_clk_2`` | ``KERNEL_CLK`` | 500 MHz           | Only used by power CU only. Fast clock to consume as much as possible |
    +--------------+----------------+-------------------+-----------------------------------------------------------------------+
